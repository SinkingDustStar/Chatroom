...
function BadgerLayout(props) {
    ...
    useEffect(()=>{
        ...
        setLoginStatus(JSON.parse(sessionStorage.getItem('username')))
    },[loginStatus])
    return (
        <div>
                        ...
                        <NavDropdown title="Chatrooms">
                            {
                                ...
                                props.chatrooms.map(chatroom => { return <NavDropdown.Item key={chatroom} as={Link} to={`chatrooms/${chatroom}`}>{chatroom}</NavDropdown.Item>})
                            }
                        </NavDropdown>
                    </Nav>
                </Container>

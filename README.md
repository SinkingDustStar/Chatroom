...
(a)follower:
1.Simple and Intuitive Use: login, logout and post are intuitive
2.Tolerance for Error: there would be alert for wrong input.
...
(b)violated:
1.Low Physical Effort 2.Flexibility in Use

both: we must fist go to according classroom, then post in that classroom
...
description: we could directly post in a specific classroom at home page.
![step10](_figures/step10.png)
